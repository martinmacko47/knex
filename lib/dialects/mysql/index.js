...
Object.assign(Client_MySQL.prototype, {
  ...
  _query(connection, obj) {
    ...
    return new Promise(function (resolver, rejecter) {
      ...
      const queryOptions = Object.assign({ sql: obj.sql, __knexQueryUid: obj.__knexQueryUid }, obj.options);
  ...
  async cancelQuery(connectionToKill, queryToKill) {
    ...
    if (index >= 0) {
      console.log('CCR', Date.now(), connectionToKill.threadId, queryToKill.__knexQueryUid)
      connectionToKill._commands.removeOne(index)
      return
    }

    console.log('CCK', Date.now(), connectionToKill.threadId, queryToKill.__knexQueryUid)
